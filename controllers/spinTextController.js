...
const validateSpinText = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Test parsing untuk detect errors
    let isValid = true;
...
const generateVariations = asyncHandler(async (req, res) => {
  ...
  const maxCount = 50; // Limit untuk avoid performance issues
